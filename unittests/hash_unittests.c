...
TEST(HASH_TIME, HASH_INSERT_REWRITE_GET_100_000)
{
	int a;
	long long int b;
	map_t M = MapHashCreate(sizeof(int), sizeof(long long int));
...
TEST(HASH_TIME, HASH_INSERT_REWRITE_GET_1_000_000)
{
	int a;
	long long int b;
	map_t M = MapHashCreate(sizeof(int), sizeof(long long int));
...
TEST(HASH_TIME, HASH_INSERT_REWRITE_GET_10_000_000)
{
	int a;
	long long int b;
	map_t M = MapHashCreate(sizeof(int), sizeof(long long int));
